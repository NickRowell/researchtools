 ...
 * @author nickrowell
 */
public class SimpleCylindrical extends Projection
{
    ...
    public SimpleCylindrical(double pLINE_PROJECTION_OFFSET, double pSAMPLE_PROJECTION_OFFSET,
    ...
    public int[] getLineSampleIndices(double lon, double lat)
    {
        ...
        double s0 = SAMPLE_PROJECTION_OFFSET + MAP_RESOLUTION*(Math.toDegrees(lon) - CENTER_LONGITUDE);
        double l0 = LINE_PROJECTION_OFFSET   - MAP_RESOLUTION*(Math.toDegrees(lat) - CENTER_LATITUDE);
