...
//        System.out.println(PhiInverse(y));
        ...
        System.out.println("\nIntegral over range [-0.5:0.5]");
        System.out.println(Phi(0.5, mu, sigma) - Phi(-0.5, mu, sigma));
        System.out.println("\nIntegral over range [0.5:1.5]");
        System.out.println(Phi(1.5, mu, sigma) - Phi(0.5, mu, sigma));
        
        System.out.println("\nIntegral over range [-1.0:1.0]");
        System.out.println(Phi(1.0, mu, sigma) - Phi(-1.0, mu, sigma));
        System.out.println("\nIntegral over range [1.0:3.0]");
        System.out.println(Phi(3.0, mu, sigma) - Phi(1.0, mu, sigma));

        System.out.println("\nIntegral over range [-2.0:2.0]");
        System.out.println(Phi(2.0, mu, sigma) - Phi(-2.0, mu, sigma));
        System.out.println("\nIntegral over range [2.0:6.0]");
        System.out.println(Phi(6.0, mu, sigma) - Phi(2.0, mu, sigma));
